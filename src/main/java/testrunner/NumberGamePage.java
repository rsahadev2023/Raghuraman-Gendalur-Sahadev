...
import pageobjects.NumberGamePage_Objects;
...
public class NumberGamePage {
    ...
    public Object[][] fetch(ITestContext testContext) throws Exception {
        ...
        String filepath=new File("C:\\Users\\User\\workspace\\BasicCalc\\src\\test\\resources\\TestData\\BasicCalc_HomePage4.xlsx").getAbsolutePath();
	...
	public void numbergamepage_Disp(HashMap<String,String> data) throws InterruptedException, IOException {
        ...
        driver.get("https://testsheepnz.github.io/index.html#the-number-game");
        System.out.println("Data : "+data);
        
        //sample
        NumberGamePage_Objects obj=new NumberGamePage_Objects(driver,data);
        //obj.click_homepagemenu();
        //obj.bascalcultor(data.get("Menu"));
        obj.click_numbergamepagemenu();
        //obj.numbergamepage();
        // Raghu
	...
	public void beftest() {
		System.out.println("Test Execution for Number Game Page Starts");
	}
}
